// xFenster2 r15.1, Copyright 2004-2007 Michael Foster (Cross-Browser.com)
// Part of X, a Cross-Browser Javascript Library, Distributed under the terms of the GNU LGPL
function xFenster2(clientId, iniTitle, iniUrl, iniX, iniY, iniW, iniH, enMove, enResize, enMaxRes, enClose, fnMove, fnResize, fnMaxRes, fnClose, fnFocus)
{
  var me = this;
  ...
  me.focus = function(e) // don't use 'this' here
  {
    if (!fnFocus || fnFocus(me)) {
      me.con.style.zIndex = xFenster2.nextZ++;
      if (xFenster2.focused) {
        xFenster2.focused.tbar.className = 'xfTBar';
        xFenster2.focused.sbar.className = 'xfSBar';
      }
      me.tbar.className = 'xfTBarF';
      me.sbar.className = 'xfSBarF';
      xFenster2.focused = me;
    }
  };
  me.href = function(s)
  {
  ...
  {
    var i, o = xFenster2.instances, z = 0, hz = 0, f = null;
    if (!fnClose || fnClose(me)) {
      me.con.style.display = 'none';
      xStopPropagation(e);
      if (me == xFenster2.focused) {
        for (i in o) {
  ...
  xFenster2.instances[clientId] = me;
  ...
  xAddEventListener(window, 'unload',
    function () {
      ...
      xFenster2.instances[clientId] = null;
      me = null;
    }, false
  );
...
} // end xFenster2 object prototype

// xFenster2 static properties
xFenster2.nextZ = 100;
xFenster2.focused = null;
xFenster2.instances = {};
