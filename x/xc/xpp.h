...
#define XPP_VER "0.01 beta"
#define XPP_BANNER "xpp %s\n"
//#define XPP_HELP "Usage: XPP output_file input_file1 input_file2 ...\n For more information visit Cross-Browser.com\n"
#define XPP_HELP "usage: xpp [-|+o] [-|+v] [-|+d] output_file input_file1 [input_file2 ...]\n where: o = output, v = verbose, d = debug\n for more information visit Cross-Browser.com\n"
