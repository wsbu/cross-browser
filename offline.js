...
function insert_header(p, r)
{
  ...
  if (p == 2)
    ...
    s += "<a href='" + r + "/x/docs/xc_reference.html' title='X Library Build Tools'>Tools</a>";
...
function insert_footer(r)
{
  ...
  s += "Copyright &copy; 2001-2009 Michael Foster<br>Javascript distributed under the terms of the <a href='";
...
function insert_sidebar(r)
{
  ...
  s += "<div>";
  s += "<p><a href='http://cross-browser.com/forums/'>X Library Support Forums</a></p>";
  s += "</div>";
  s += "<h3>License</h3>";
  s += "<div>";
...
function get_doc_links(r)
{
  ...
  s += "<p><a href='" + r + "/x/docs/xc_reference.html'>X Tools</a> - Summary and revision history for the X build tool chain.</p>";
...
{
  var s = '';
  s += "<p><a href='http://cross-browser.com/toys/'>X Library Demos</a> (online) - This offline package only includes a few demos. See all the X Library demos online!</p>";
  s += "<p><a href='" + r + "/x/examples/demo1.html'>demo1</a> - This is the demo for the tutorial.</p>";
  s += "<p><a href='" + r + "/x/examples/pick-a-card.html'>Pick a card</a> - An xEnableDrag demo.</p>";
  s += "<p><a href='" + r + "/x/examples/xanimation-sequence-2.html'>xAnimation r4.1</a> - An xAnimation experiment.</p>";
  s += "<p><a href='" + r + "/x/examples/xfenster5.html'>xFenster r19</a> - An xFenster experiment.</p>";
  s += "<p><a href='" + r + "/x/examples/tabpanelgroup.html'>xTabPanelGroup</a> - Downgradeable, accessible, tabbed panels.</p>";
  s += "<p><a href='" + r + "/x/examples/xthf1.html'>xTableHeaderFixed demo 1</a> - where the container is the window.</p>";
  s += "<p><a href='" + r + "/x/examples/xthf2.html'>xTableHeaderFixed demo 2</a> - where the container is a scrollable element.</p>";
  s += "<p><a href='http://cross-browser.com/x/examples/xthf3.php'>xTableHeaderFixed demo 3</a> (online) - where the tables are served via Ajax.</p>";
  return s;
}

function insert_xthf_tables()
{
  var s = "<h4>Table 1</h4>"
+ "<div>"
+ "<table class='xthf-site' cellSpacing='0'>"
...
+ "<h4>Table 2</h4>"
+ "<div>"
+ "<p>This table has no caption.</p>"
+ "<table class='xthf-green' cellSpacing='0'>"
+ "<thead>"
...
+ "<h4>Table 3</h4>"
+ "<div>"
+ "<p>This table has a row of colspan'd TDs in the THEAD.</p>"
+ "<table class='xthf-blue' cellSpacing='0'>"
+ "<caption>Table 3 Caption</caption>"
+ "<thead>"
